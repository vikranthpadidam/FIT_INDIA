...
const newStudent = new Student({
  userId: "gojo", // replace with your desired userId
  password: "143", // replace with your desired password
  profileImg:
    "https://tse1.mm.bing.net/th?id=OIP.Ql99TFgedm2sY6vzkrpKhwHaEJ&pid=Api&rs=1&c=1&qlt=95&w=204&h=114",
});
...
//getting error in inserting
// const newAdminone = new Admin({
//   userId: "w",
//   password: "2",
// });
// newAdminone.save()
//   .then(() => { console.log('Admineone inserted!'); })
